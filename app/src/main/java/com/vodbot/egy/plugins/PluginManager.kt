package com.vodbot.egy.plugins
...
import com.vodbot.egy.APIHolder.removePluginMapping
...
import com.vodbot.egy.mvvm.debugPrint
import com.vodbot.egy.mvvm.logError
import com.vodbot.egy.mvvm.normalSafeApiCall
import com.vodbot.egy.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import com.vodbot.egy.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import com.vodbot.egy.plugins.RepositoryManager.downloadPluginToFile
import com.vodbot.egy.plugins.RepositoryManager.getRepoPlugins
import com.vodbot.egy.ui.settings.extensions.REPOSITORIES_KEY
import com.vodbot.egy.ui.settings.extensions.RepositoryData
...
import com.vodbot.egy.utils.VideoDownloadManager.sanitizeFilename
