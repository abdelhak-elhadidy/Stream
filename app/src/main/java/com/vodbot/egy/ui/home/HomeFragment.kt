package com.vodbot.egy.ui.home
...
import com.vodbot.egy.APIHolder.apis
import com.vodbot.egy.APIHolder.filterProviderByPreferredMedia
import com.vodbot.egy.APIHolder.getApiFromNameNull
import com.vodbot.egy.APIHolder.getApiProviderLangSettings
import com.vodbot.egy.APIHolder.getId
import com.vodbot.egy.AcraApplication.Companion.getKey
import com.vodbot.egy.MainActivity.Companion.afterPluginsLoadedEvent
import com.vodbot.egy.MainActivity.Companion.mainPluginsLoadedEvent
import com.vodbot.egy.mvvm.Resource
import com.vodbot.egy.mvvm.logError
import com.vodbot.egy.mvvm.observe
import com.vodbot.egy.syncproviders.AccountManager.Companion.OAuth2Apis
import com.vodbot.egy.ui.APIRepository.Companion.noneApi
import com.vodbot.egy.ui.APIRepository.Companion.randomApi
import com.vodbot.egy.ui.AutofitRecyclerView
import com.vodbot.egy.ui.WatchType
import com.vodbot.egy.ui.quicksearch.QuickSearchFragment
import com.vodbot.egy.ui.result.ResultViewModel2.Companion.updateWatchStatus
import com.vodbot.egy.ui.result.START_ACTION_RESUME_LATEST
import com.vodbot.egy.ui.result.setLinearListLayout
import com.vodbot.egy.ui.search.*
import com.vodbot.egy.ui.search.SearchHelper.handleSearchClickCallback
import com.vodbot.egy.ui.settings.SettingsFragment.Companion.isTrueTvSettings
import com.vodbot.egy.ui.settings.SettingsFragment.Companion.isTvSettings
import com.vodbot.egy.utils.AppUtils.isRecyclerScrollable
import com.vodbot.egy.utils.AppUtils.loadResult
import com.vodbot.egy.utils.AppUtils.loadSearchResult
import com.vodbot.egy.utils.AppUtils.setMaxViewPoolSize
import com.vodbot.egy.utils.Coroutines.ioSafe
import com.vodbot.egy.utils.DataStore.getKey
import com.vodbot.egy.utils.DataStore.setKey
import com.vodbot.egy.utils.DataStoreHelper
import com.vodbot.egy.utils.DataStoreHelper.deleteAllBookmarkedData
import com.vodbot.egy.utils.DataStoreHelper.deleteAllResumeStateIds
import com.vodbot.egy.utils.DataStoreHelper.removeLastWatched
import com.vodbot.egy.utils.DataStoreHelper.setResultWatchState
import com.vodbot.egy.utils.Event
import com.vodbot.egy.utils.SingleSelectionHelper.showBottomDialog
import com.vodbot.egy.utils.SingleSelectionHelper.showOptionSelectStringRes
import com.vodbot.egy.utils.SubtitleHelper.getFlagFromIso
import com.vodbot.egy.utils.UIHelper.dismissSafe
import com.vodbot.egy.utils.UIHelper.fixPaddingStatusbar
import com.vodbot.egy.utils.UIHelper.fixPaddingStatusbarView
import com.vodbot.egy.utils.UIHelper.getResourceColor
import com.vodbot.egy.utils.UIHelper.getSpanCount
import com.vodbot.egy.utils.UIHelper.getStatusBarHeight
import com.vodbot.egy.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.vodbot.egy.utils.UIHelper.setImage
import com.vodbot.egy.utils.UIHelper.setImageBlur
import com.vodbot.egy.utils.USER_SELECTED_HOMEPAGE_API
import com.vodbot.egy.widget.CenterZoomLayoutManager
