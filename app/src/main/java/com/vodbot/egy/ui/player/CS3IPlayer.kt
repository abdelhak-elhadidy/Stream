...
import com.vodbot.egy.USER_AGENT
...
import com.vodbot.egy.utils.ExtractorLinkPlayList
...
//                .setTunnelingEnabled(true)
    ...
    private fun loadExo(
        ...
        val maxVideoHeight = settingsManager.getInt(
            context.getString(com.vodbot.egy.R.string.quality_pref_key),
            Int.MAX_VALUE
        )
                        ...
                        when (playbackState) {
                            ...
                            Player.STATE_ENDED -> {
                                ...
                                if (PreferenceManager.getDefaultSharedPreferences(context)
                                        ?.getBoolean(
                                            context.getString(com.vodbot.egy.R.string.autoplay_next_key),
                                            true
                                        ) == true
                                ) {
                                    handleEvent(CSPlayerEvent.NextEpisode)
