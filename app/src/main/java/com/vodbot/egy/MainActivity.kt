...
import com.vodbot.egy.APIHolder.allProviders
import com.vodbot.egy.APIHolder.apis
import com.vodbot.egy.APIHolder.getApiDubstatusSettings
import com.vodbot.egy.APIHolder.initAll
import com.vodbot.egy.APIHolder.updateHasTrailers
import com.vodbot.egy.AcraApplication.Companion.removeKey
import com.vodbot.egy.AcraApplication.Companion.setKey
import com.vodbot.egy.CommonActivity.loadThemes
import com.vodbot.egy.CommonActivity.onColorSelectedEvent
import com.vodbot.egy.CommonActivity.onDialogDismissedEvent
import com.vodbot.egy.CommonActivity.onUserLeaveHint
import com.vodbot.egy.CommonActivity.showToast
import com.vodbot.egy.CommonActivity.updateLocale
import com.vodbot.egy.mvvm.logError
import com.vodbot.egy.network.initClient
import com.vodbot.egy.plugins.PluginManager
import com.vodbot.egy.plugins.PluginManager.loadSinglePlugin
import com.vodbot.egy.receivers.VideoDownloadRestartReceiver
import com.vodbot.egy.syncproviders.AccountManager.Companion.OAuth2Apis
import com.vodbot.egy.syncproviders.AccountManager.Companion.accountManagers
import com.vodbot.egy.syncproviders.AccountManager.Companion.appString
import com.vodbot.egy.syncproviders.AccountManager.Companion.appStringRepo
import com.vodbot.egy.syncproviders.AccountManager.Companion.inAppAuths
import com.vodbot.egy.ui.APIRepository
import com.vodbot.egy.ui.download.DOWNLOAD_NAVIGATE_TO
import com.vodbot.egy.ui.search.SearchResultBuilder
import com.vodbot.egy.ui.settings.SettingsFragment.Companion.isEmulatorSettings
import com.vodbot.egy.ui.settings.SettingsFragment.Companion.isTvSettings
import com.vodbot.egy.ui.settings.SettingsGeneral
import com.vodbot.egy.ui.setup.HAS_DONE_SETUP_KEY
import com.vodbot.egy.ui.setup.SetupFragmentExtensions
import com.vodbot.egy.utils.AppUtils.isCastApiAvailable
import com.vodbot.egy.utils.AppUtils.loadCache
import com.vodbot.egy.utils.AppUtils.loadRepository
import com.vodbot.egy.utils.AppUtils.loadResult
import com.vodbot.egy.utils.BackupUtils.setUpBackup
...
import com.vodbot.egy.utils.DataStoreHelper.migrateResumeWatching
import com.vodbot.egy.utils.Event
import com.vodbot.egy.utils.IOnBackPressed
import com.vodbot.egy.utils.InAppUpdater.Companion.runAutoUpdate
import com.vodbot.egy.utils.UIHelper.changeStatusBarState
import com.vodbot.egy.utils.UIHelper.checkWrite
import com.vodbot.egy.utils.UIHelper.colorFromAttribute
import com.vodbot.egy.utils.UIHelper.getResourceColor
import com.vodbot.egy.utils.UIHelper.hideKeyboard
import com.vodbot.egy.utils.UIHelper.navigate
import com.vodbot.egy.utils.UIHelper.requestRW
import com.vodbot.egy.utils.USER_PROVIDER_API
